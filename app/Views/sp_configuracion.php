...
<body>
    <form action="<?php echo base_url();?>datos_dispositivo" method="post">
    ...
    <form action="<?php echo base_url();?>cerrar_session" method="post">
    <input type="submit" value="Cerrar Session">
    </form>
    <script type="text/javascript">
    setTimeout(function() {
        $.ajax({
        url:  '<?php echo base_url('/cargar_pp'); ?>',
        success: function() {
        window.location.href = '<?php echo base_url('/cargar_pp'); ?>';
        },
